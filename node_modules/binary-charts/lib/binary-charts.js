...
/***/ function(module, exports, __webpack_require__) {
	...
	var _areTickArraysEqual = __webpack_require__(49);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var lineColor = (0, _brandColor2.default)(1);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getLastTick = __webpack_require__(12);
	...
	exports.default = function (_ref) {
	    ...
	    var lastTick = (0, _getLastTick2.default)(ticks);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateExtremesYAxis = function updateExtremesYAxis(axis, ticks, contract) {
	    ...
	    var prevExtermes = axis.getExtremes();
	    var minExtremes = [0, +contract.barrier2 - 10, prevExtermes.dataMin].filter(function (x) {
	        return x;
	    });
	    var min = arrayMin(minExtremes);
	    var maxExtremes = [+contract.barrier + 10, prevExtermes.dataMax].filter(function (x) {
	        return x;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _doTicksDifferJustOneEntry = __webpack_require__(51);
	
	var _doTicksDifferJustOneEntry2 = _interopRequireDefault(_doTicksDifferJustOneEntry);
	
	var _tickToData = __webpack_require__(53);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateToEpoch = __webpack_require__(50);
	...
	exports.default = function (_ref) {
	    ...
	    return [{
	        ...
	        fillColor: {
	            ...
	            stops: [[0, (0, _brandColor2.default)(0.25)], [1, (0, _brandColor2.default)(0.1)]]
	        },
	        lineWidth: 1,
	        fillOpacity: 0.1,
	        threshold: null
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialize = function initialize(_ref) {
	    ...
	    spotIndicator.poly = renderer.path(polyPath(priceYAxis.width + x - 5, y, x, 15)).attr({
	        fill: options.color
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _doTicksEqual = __webpack_require__(52);
