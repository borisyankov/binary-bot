(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["binary-charts"] = factory(require("react"));
	else
		root["binary-charts"] = factory(root["React"]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reset = __webpack_require__(26);
	
	var _reset2 = _interopRequireDefault(_reset);
	
	var _plotOptions = __webpack_require__(24);
	...
	var _rangeSelector = __webpack_require__(25);
	
	var _rangeSelector2 = _interopRequireDefault(_rangeSelector);
	
	var _yAxis = __webpack_require__(29);
	
	var _yAxis2 = _interopRequireDefault(_yAxis);
	
	var _xAxis = __webpack_require__(28);
	
	var _xAxis2 = _interopRequireDefault(_xAxis);
	
	var _seriesLine = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _updateTicks = __webpack_require__(19);
	
	var _updateTicks2 = _interopRequireDefault(_updateTicks);
	
	var _updateContract = __webpack_require__(17);
	
	var _updateContract2 = _interopRequireDefault(_updateContract);
	
	var _updateTradingTimes = __webpack_require__(20);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _barrier2FromContract = __webpack_require__(10);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _vertPlotLine = __webpack_require__(9);
	...
	var timePlotLines = exports.timePlotLines = [{ id: 'date_start', name: 'Start Time', position: 'left' }, { id: 'purchase_time', name: 'Purchase Time', position: 'left' }, { id: 'entry_tick_time', name: 'Entry Spot', position: 'right' }, { id: 'date_expiry', name: 'Time of Expiry', position: 'left' }, { id: 'date_settlement', name: 'Settlement Time', position: 'right' }, { id: 'expiry_time', name: 'End Time', position: 'right' }, { id: 'exit_tick_time', name: 'Exit Spot', position: 'left' }, { id: 'sell_spot_time', name: 'Sell Time', position: 'right' }];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _highstock = __webpack_require__(3);
	
	var _highstock2 = _interopRequireDefault(_highstock);
	
	var _BinaryTypes = __webpack_require__(15);
	
	var BinaryTypes = _interopRequireWildcard(_BinaryTypes);
	
	var _initChart = __webpack_require__(4);
	
	var _initChart2 = _interopRequireDefault(_initChart);
	
	var _updateChart = __webpack_require__(5);
	
	var _updateChart2 = _interopRequireDefault(_updateChart);
	
	var _spotIndicator = __webpack_require__(47);
	
	var _spotIndicator2 = _interopRequireDefault(_spotIndicator);
	
	var _tradeMarker = __webpack_require__(48);
	
	var _tradeMarker2 = _interopRequireDefault(_tradeMarker);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _plotBands = __webpack_require__(41);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateExtremesYAxis = function updateExtremesYAxis(axis, ticks, contract) {
	    ...
	    var prevExtremes = axis.getExtremes();
	    var minExtremes = [0, +contract.barrier2 - 10, prevExtremes.dataMin].filter(function (x) {
	        return x;
	    });
	    var min = arrayMin(minExtremes);
	    var maxExtremes = [+contract.barrier + 10, prevExtremes.dataMax].filter(function (x) {
	        return x;
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _tickToData = __webpack_require__(56);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BinaryChart = __webpack_require__(13);
	
	var _BinaryChart2 = _interopRequireDefault(_BinaryChart);
	
	var _NonReactBinaryChart = __webpack_require__(14);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _upOrDownPlotBand = __webpack_require__(7);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _rangePlotBand = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = function () {
	    function renderTradeMarker(chart) {
	        ...
	        var lastPoint = series.data[len];
	
	        if (!lastPoint) return;
	
	        var pixelX = chart.xAxis[0].toPixels(lastPoint.x);
	        var pixelY = chart.yAxis[0].toPixels(lastPoint.y);
	
	        chart.tradeMarker = chart.renderer.circle(pixelX, pixelY, 3).attr({
...
;
//# sourceMappingURL=binary-charts.js.map